...
const cases: Case[] = [
  [
    "agent list",
    (c) => c.agents.list({ customer_id: customer, page: 2 }),
    "GET",
    "/agents",
    undefined,
    { customer_id: customer, page: "2" },
  ],
  ["agent get", (c) => c.agents.get(id), "GET", "/agents/a%2Fb"],
  ["agent models", (c) => c.agents.models(), "GET", "/agents/models"],
  [
    "agent draft",
    (c) => c.agents.behavior(id),
    "GET",
    "/agents/a%2Fb/behavior",
  ],
  [
    "agent create",
    (c) =>
    ...
    "/agents",
    {
      customer_id: customer,
      name: "Comercial",
      offerings: [{ name: "Plano", pricing_kind: "quote", price_cents: null }],
    },
  ],
  [
    "agent update CAS",
  ...
  [
    "agent control",
    (c) => c.agents.control(id, { action: "review" }),
    "POST",
    "/agents/a%2Fb/control",
    { action: "review" },
  ],
  [
    "agent runs",
    (c) => c.agents.runs(id, { page: 2 }),
    "GET",
    "/agents/a%2Fb/runs",
    undefined,
    { page: "2" },
  ...
  [
    "agent preview charge key",
    (c) =>
      c.agents.preview(id, { scenario: "price", request_key: "stable-key" }),
    "POST",
    "/agents/a%2Fb/preview",
    { scenario: "price", request_key: "stable-key" },
  ],
  [
    "agent gaps",
    (c) => c.agents.gaps(id, { page: 2 }),
    "GET",
    "/agents/a%2Fb/gaps",
    undefined,
    { page: "2" },
  ...
  [
    "agent correction",
    (c) => c.agents.resolveGap(id, id, { answer: "Verificado" }),
    "PATCH",
    "/agents/a%2Fb/gaps/a%2Fb",
    { answer: "Verificado" },
  ],
  [
    "agent pause conversation",
    (c) => c.agents.controlConversation(id, "pause"),
    "POST",
    "/conversations/a%2Fb/agent-control",
    { action: "pause" },
  ],
  [
    "agent behavior save",
    (c) =>
      c.agents.saveBehavior(id, {
        model_id: "botozap.recommended",
        rules: "Conferir preço",
        fallback_model_ids: [],
      }),
    "PUT",
    "/agents/a%2Fb/behavior",
  ...
  [
    ...
    (c) => c.agents.previewBehavior(id, { scenario: "handoff" }),
    "POST",
    "/agents/a%2Fb/behavior/control",
    { action: "preview", scenario: "handoff" },
  ],
  [
    "agent behavior publish",
    (c) => c.agents.publishBehavior(id),
    "POST",
    "/agents/a%2Fb/behavior/control",
    { action: "publish" },
  ],
